...
- (void)setSource:(FFFastImageSource *)source {
    if (_source != source) {
        ...
        [[PINRemoteImageManager sharedImageManager] downloadImageWithURL: _source.url options: PINRemoteImageManagerDownloadOptionsNone progressDownload:^(int64_t completedBytes, int64_t totalBytes) {
            if (_onFastImageProgress) {
                _onFastImageProgress(@{
