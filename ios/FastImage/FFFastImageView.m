...
- (void)setSource:(FFFastImageSource *)source {
    if (_source != source) {
        ...
        if ([_source.url.pathExtension isEqualToString:@"gif"]) {
            // Load gif using FLAnimatedImage
            self.animatedImage = [FLAnimatedImage animatedImageWithGIFData:[NSData dataWithContentsOfURL:_source.url]];
            self.hasCompleted = YES;
